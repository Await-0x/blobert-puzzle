import { Box, Dialog, Typography, Button, Stack, Divider } from '@mui/material';
import { useEffect } from "react";
import { argent, braavos, useConnect, useAccount } from "@starknet-react/core";
...
function ConnectWallet(props) {
  ...
  return (
    <Dialog
      ...
      maxWidth={'lg'}
      PaperProps={{
        sx: { background: '#feffda', border: '2px solid #ffb546' }
      }}
    >
